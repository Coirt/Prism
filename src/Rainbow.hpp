...
struct Audio {
	...
	dsp::SampleRateConverter<1> nOutputSrc[6];
	dsp::DoubleRingBuffer<dsp::Frame<1>, 256> nOutputBuffer[6];
	...
	dsp::Frame<1> nOutputFrame[6] = {};
	dsp::Frame<1> nOutputFrames[6][NUM_SAMPLES] = {};
